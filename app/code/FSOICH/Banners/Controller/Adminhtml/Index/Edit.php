...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('FSOICH_Banners::banners');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('FSOICH_Banners::banners')
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('FSOICH\Banners\Model\Banners');
