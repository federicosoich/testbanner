 ...
 */
namespace FSOICH\Banners\Controller\Adminhtml\Index;

use Magento\Backend\App\Action\Context;
use Magento\Backend\App\Action;
use FSOICH\Banners\Model\Banners;
...
//use FSOICH\News\Model\ResourceModel\Test\CollectionFactory;
   ...
   //  protected $filter;
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('FSOICH\Banners\Model\Banners')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('fsoich_banners');
            ...
            $this->dataPersistor->set('fsoich_banners', $data);
